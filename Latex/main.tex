...
\textbf{Bản dưới đây:} toàn bộ mã đã \textbf{gỡ chú thích} (\texttt{//} và \texttt{/* */}) để phụ lục gọn; nội dung nằm trong \file{iot.txt} (469 dòng).
...
\IfFileExists{iot.txt}{%
  \lstinputlisting[
    style=appendixcode,
    caption={Firmware ESP8266 (đã gỡ chú thích, 469 dòng)},
